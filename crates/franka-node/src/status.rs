...
mod tests {
    ...
    fn status_json_follows_the_recorded_state() {
        ...
        left.set_recording(Some("L-20260911T120000Z.rrd".into()));
        left.set_episode(Some("L-20260911T120000Z".into()));
        ...
        assert_eq!(
            ...
            ArmStatus {
                ...
                decode_failures: 3,
                success_rate: 0.98,
                recording: Some("L-20260911T120000Z.rrd".into()),
                episode: Some("L-20260911T120000Z".into()),
                gripper: None,
            }
        );
        assert_eq!(
        ...
        assert_eq!(json["arms"][0]["recording"], "L-20260911T120000Z.rrd");
