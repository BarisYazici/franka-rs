...
mod tests {
    ...
    fn episode_json_round_trips() {
        let msg = EpisodeMsg {
            arm: "L".into(),
            recording_id: "L-20260911T142627Z".into(),
            file: Some("L-20260911T142627Z.rrd".into()),
            t_node_ns: 12,
            phase: EpisodePhase::Start,
        };
        assert_eq!(
            msg.to_json(),
            r#"{"arm":"L","recording_id":"L-20260911T142627Z","file":"L-20260911T142627Z.rrd","t_node_ns":12,"phase":"start"}"#
        );
        let end = EpisodeMsg {
            file: None,
