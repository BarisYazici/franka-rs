...
impl LiveTuning {
    ...
    /// design record: the joint ceilings are hil_rl's, less the crate's own velocity barrier
    ...
    pub const BOUNDS: &'static [FieldBound] = &{
        ...
        while i < 7 {
            ...
            .advise();
            // The ceiling is 60 rather than hil_rl's 80 because near the joint's velocity
